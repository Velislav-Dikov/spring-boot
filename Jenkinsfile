...
post {         
        always { 
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'testing-junit5-mockito/target/site', reportFiles: 'surefire-report.html,java-app-report.html', reportName: 'HTML Report', reportTitles: ''])
        }
    }
}
